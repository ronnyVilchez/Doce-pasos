...
export const PasoUno = () => {
    ...
    return (
        <section className=" relative bg-cover bg-center bg-fixed min-h-screen bg-[url('/images/fondo1.jpg')] ">
            ...
            <section className="relative z-10  h-full p-6 flex flex-col gap-3 ">
                ...
                <span className='underline cursor-pointer text-end' onClick={() => { setmod1(!mod1) }}>Leer más...</span>
                <section onClick={() => { setmod1(!mod1) }} className={`${mod1 ? 'flex' : 'hidden'} flex-col gap-1`}>
                    <p>
                        Muchos de nosotros caímos en la adicción movidos por la curiosidad. Algunos quedamos atrapados
                        en ella por la justificable necesidad de consumir un medicamento con prescripción médica o bien como acto consciente de rebeldía. Muchos inician ese camino apenas entran en la adolescencia. Cualesquiera que fue- ran los motivos o las circunstancias que nos convirtieron en adictos, no tardamos en descubrir que la adicción ali- viaba más que el mero dolor físico, pues proporcionaba estimulación o anulaba los sentimientos y las emociones que generaban dolor. Evitaba que nos enfrentáramos a nuestros problemas, o eso creíamos. Durante un tiempo nos sentimos libres del miedo, de las preocupaciones, de la soledad, del desánimo, del pesar o del aburri- miento. Pero como la vida está repleta de situaciones que provocan ese tipo de sentimientos, cada vez recurrí- amos más a nuestras adicciones. Aun así, la mayoría de nosotros no reconocía ni admitía que hubiéramos per- dido la capacidad de resistir y abstenernos. El élder Russell M. Nelson, del Quórum de los Doce, observó: “Con el tiempo, la adicción rinde nuestra libertad de elección. A través de medios químicos, uno puede lite- ralmente privarse a sí mismo de su albedrío” (“Vicio o libertad”, Liahona, enero de 1989, pág. 6).

                    </p>
                    <p>
                        Rara vez las personas presas de una conducta adic- tiva admiten su adicción. Para negar la gravedad de nuestra situación y evitar ser arrestados, o sufrir las consecuencias de nuestras decisiones, intentamos res- tar importancia a nuestro comportamiento, e incluso ocultarlo, sin darnos cuenta de que al engañar a los demás y a nosotros mismos, caíamos más en nuestras adicciones. A medida que crecía nuestra impotencia sobre la adicción, muchos tratamos de culpar a nues- tros familiares y amigos, a los líderes de la Iglesia e incluso a Dios. Cada vez nos aislábamos más y nos ale- jábamos de las personas y, concretamente, de Dios.
                    </p>
                    <p>
                    ...
                    <p>
                        Un ser querido, un doctor, un juez o un líder ecle- siástico nos dijo la verdad que ya no podíamos seguir negando: la adicción estaba destruyendo nuestra vida. Al volver la mirada sinceramente hacia el pasado, admi- timos que nada de lo que habíamos intentado por no- sotros mismos había tenido éxito y reconocimos que
                        la adicción simplemente había empeorado. Nos dimos cuenta de lo mucho que nuestras adicciones habían dañado nuestras relaciones y nos habían despojado de cualquier sentimiento de autoestima. En este punto, dimos el primer paso hacia la libertad y la recupera- ción, y hallamos valor para admitir que nos enfrentába- mos a algo más que un mero problema o un mal hábito. Finalmente, admitimos la verdad de que había- mos perdido el control de nuestra vida y que necesitá- bamos ayuda para superar las adicciones. Lo sorprendente de esa sincera aceptación de la derrota es que por fin se inició la recuperación.
                ...
                <section >
                    <h2 className=' underline cursor-pointer' onClick={() => { setmod2(!mod2) }}>
                ...
                <section>
                    <h2 className=' underline cursor-pointer' onClick={() => { setmod3(!mod3) }}>
                ...
                <section>
                    <h2 className=' underline cursor-pointer' onClick={() => { setmod4(!mod4) }}>
                ...
                <span className=' uppercase'>Estudio y comprensión</span>
                <span className=' underline cursor-pointer' onClick={() => { setmod5(!mod5) }}>Leer más...</span>
                ...
                <button onClick={() => navigate('/2')} className='w-full h-12 rounded-xl flex justify-center items-center gap-4 bg-[#d19945]' >
