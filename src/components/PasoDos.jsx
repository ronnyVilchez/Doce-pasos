    ...
    return (
        <section className=" relative bg-cover bg-center bg-fixed min-h-screen bg-[url('/images/fondo1.jpg')] ">
            ...
            <section className="relative z-10  h-full p-6 flex flex-col gap-3 font-roboto">
                <h1 className='font-semibold text-xl text-center'>PASO 2: LA ESPERANZA</h1>
                ...
                <section className='gap-4 flex flex-col'>
                    ...
                    <section className={`${mod3 ? 'flex' : 'hidden'} flex-col gap-1`}>
                        ...
                        <p className='text-justify'>
                            La acción requerida en el paso 2 consiste básica- mente en estar dispuestos a creer en el amor y la misericordia de nuestro Padre Celestial y de Jesucristo, así como en la accesibilidad y la bendición del Espíritu Santo. Testificamos que puede llegar a conocer el amor perfectamente unido de la Divinidad al contemplar la evidencia de ese amor y de ese poder en su propia vida y en la de los demás.
                        </p>
